...
- [ ] 05-03-PLAN.md — Structural regression pass: interceptor only on shared instance, no router import in service, 401-only + 403 passthrough, recorded greps + build green
...
| 5. Session Refresh | 1/3 | In Progress|  |
