...
- [x] 06-03: Implement the Phase 2 partial-approval rule in `closeVoting`, replacing "first partial vote wins" + tests encoding the rule
...
| 6. Voting & Money State Machine | 4/5 | In Progress|  |
